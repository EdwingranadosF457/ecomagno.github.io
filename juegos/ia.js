(function() {
  ...
  const consejosAmbientales = {
    'reciclaje': '♻️ Para reciclar correctamente: separa papel, plástico y vidrio en contenedores diferentes. Limpia los envases antes de reciclarlos.',
    ...
    'bolsa': '🛍️ Lleva siempre bolsas reutilizables al hacer compras. Una bolsa de tela puede usarse cientos de veces.',
    'basura': '🗑️ Separa correctamente tus residuos: orgánicos, reciclables y no reciclables. Esto facilita su tratamiento.',
    ...
    'contaminacion': '☠️ La contaminación daña el aire, agua y suelo. Evita usar productos químicos innecesarios.'
  };
